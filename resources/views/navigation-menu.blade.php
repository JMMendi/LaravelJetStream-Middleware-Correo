            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('articles') }}" :active="request()->routeIs('articles')">
                        <i class="fa-solid fa-gauge mr-1"></i>{{ __('Gestión de Artículos') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('tags.index') }}" :active="request()->routeIs('tags.*')">
                        <i class="fa-solid fa-gauge mr-1"></i>{{ __('Gestión de Etiquetas') }}
                    </x-nav-link>
                    @endauth
                    <x-nav-link href="{{ route('contacto.pintar') }}" :active="request()->routeIs('contacto.pintar')">
                        <i class="fa-solid fa-gauge mr-1"></i>{{ __('Contacto') }}
                    </x-nav-link>
                </div>
            </div>
