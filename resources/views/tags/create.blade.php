<x-app-layout>
    <x-self.base>
        <form action="{{route('tags.store')}}" method="POST" class="w-1/2 mx-auto bg-gray-800 p-2 rounded-xl">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <textarea name="description" id="description" rows="5" cols="50">{{@old('description')}}</textarea>
                <x-input-error for="description"/>
            </div>
            <x-button type="submit" class="text-white p-2">Guardar</x-button>
